...
class _TransaksiPageState extends State<TransaksiPage> {
  ...
  final int biayaPengiriman = 10000;

  int get totalHargaObat => widget.cartItems.fold(
      0, (total, item) => total + (item.obat.hargaJual * item.quantity).toInt());
  int get totalHarga => totalHargaObat + biayaPengiriman;

  List<CartItem> cartItemsSnapshot = [];
  ...
  Future<void> _submitTransaksi() async {
    ...
    try {
      ...
      if (result['message'] == 'Penjualan berhasil disimpan') {
        ...
        cartItemsSnapshot = List<CartItem>.from(widget.cartItems);
        cart.clearCart();
              ...
              children: [
                  ...
                  (item) => Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            '${item.obat.namaObat} x${item.quantity}',
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text('Rp${biayaPengiriman.toStringAsFixed(0)}',
                        style: const TextStyle(fontSize: 16)),
                  ],
                ),
                const Divider(height: 24),
                    ...
                    (item) => Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Rp${item.obat.hargaJual.toStringAsFixed(0)}',
                            style: const TextStyle(
                                fontWeight: FontWeight.bold),
                          ),
                        ],
...
}// END of class _TransaksiPageState
